...
from training.refactored_batched_dataset import PolymerSeparatedDatasetFGFingerprint
from tools.smiles_transformers import PolymerisationSmilesTransform
from torch.utils.data import DataLoader
from training.trainer_3_features import FGGNNTrainerWithJSON
import random
import numpy as np
...
fg_n_bits = 64
train_dataset = PolymerSeparatedDatasetFGFingerprint(
    data=train_df,
...
val_dataset = PolymerSeparatedDatasetFGFingerprint(
    data=val_df,
...
test_dataset = PolymerSeparatedDatasetFGFingerprint(
    data=test_df,
    pipeline_manager=fitted_pipeline_manager,
    monomer_smiles_column=monomer_smiles_column,
    solvent_smiles_column=solvent_smiles_column,
...
gnn_trainer = FGGNNTrainerWithJSON(
