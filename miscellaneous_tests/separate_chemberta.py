...
from training.trainer_3_features import SeparatedGNNChemBertaTrainer
...
gnn_trainer = SeparatedGNNChemBertaTrainer(
...
if __name__ == "__main__":
    ...
    torch.save(gnn_trainer.model.state_dict(), "march_28_v3_chemberta.pth")
