...
from training.refactored_batched_dataset import PolymerMorganSeparatedFingerprintDataset
...
train_dataset = PolymerMorganSeparatedFingerprintDataset(
    data=train_df,
    n_bits=n_bits,
...
val_dataset = PolymerMorganSeparatedFingerprintDataset(
    data=val_df,
    n_bits=n_bits,
...
test_dataset = PolymerMorganSeparatedFingerprintDataset(
    data=test_df,
    n_bits=n_bits,
    pipeline_manager=fitted_pipeline_manager,
    monomer_smiles_column=monomer_smiles_column,
