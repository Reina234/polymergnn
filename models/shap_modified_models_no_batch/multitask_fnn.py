...
class ShapMorganPolymerMultiTaskFNN(nn.Module):
    def __init__(
        self,
    ...
    def forward(self, polymer_embedding, polymer_feats, n_bits):
...
class ShapPolymerMultiTaskFNN(nn.Module):
    def __init__(
        self,
        input_dim: int,  # Polymer embedding + N, T
        shared_layer_dim: int,
    ...
    def forward(self, polymer_embedding, polymer_feats):
        """
