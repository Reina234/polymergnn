...
# MUST be used with 3 features, density, N, T
# note that my other models all had 2 features, so input dim is diff


class MorganPolymerGNNSystem3Feature(nn.Module):
    def __init__(
        self,
        n_bits: int,
