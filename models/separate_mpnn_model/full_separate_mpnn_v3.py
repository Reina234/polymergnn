...
from models.separate_mpnn_model.mpnn_embedder_fg import FGFusionMoleculeEmbeddingModel
...
class SeparatedGNNSystemFG(nn.Module):
    ...
    def __init__(
        ...
        self.monomer_embedding = FGFusionMoleculeEmbeddingModel(
            chemprop_mpnn=mpnn,
            ...
            fg_n_bits_dim=fg_n_bits,
        )
        self.solvent_embedding = FGFusionMoleculeEmbeddingModel(
            chemprop_mpnn=mpnn,
            rdkit_featurizer=RDKitFeaturizer(),
            selected_rdkit_features=selected_rdkit_features,
            hidden_dim=molecule_embedding_hidden_dim,
