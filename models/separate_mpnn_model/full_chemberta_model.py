...
from models.separate_mpnn_model.chemberta_fusion import (
    ChembertaFusionMoleculeEmbeddingModel,
)


class SeparatedGNNSystemChemberta(nn.Module):
    ...
    def __init__(
        ...
        self.monomer_embedding = ChembertaFusionMoleculeEmbeddingModel(
            chemprop_mpnn=mpnn,
        ...
        self.solvent_embedding = ChembertaFusionMoleculeEmbeddingModel(
            chemprop_mpnn=mpnn,
            rdkit_featurizer=RDKitFeaturizer(),
            selected_rdkit_features=selected_rdkit_features,
            hidden_dim=molecule_embedding_hidden_dim,
