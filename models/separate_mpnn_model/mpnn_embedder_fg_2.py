...
class FGFusionMoleculeEmbeddingModel(nn.Module):
    ...
    def __init__(
        ...
        rdkit_dim = len(selected_rdkit_features)  # e.g., 7
        ...
        # Fusion Layer
        fused_dim = self.mpnn_dim + rdkit_dim + fg_n_bits_dim
    ...
    def forward(self, molgraphs, rdkit_tensor, fg_tensor):  # CONTINUEEE
        ...
        fused_input = torch.cat([mpnn_out, selected_rdkit, fg_tensor], dim=-1)
