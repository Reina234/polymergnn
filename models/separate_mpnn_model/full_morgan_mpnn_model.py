...
from models.separate_mpnn_model.mpnn_embedder_morgan import (
    MorganFusionMoleculeEmbeddingModel,
)


class SeparatedGNNSystemV3Morgan(nn.Module):
    ...
    def __init__(
        ...
        self.monomer_embedding = MorganFusionMoleculeEmbeddingModel(
            n_bits=n_bits,
            chemprop_mpnn=mpnn,
        ...
        self.solvent_embedding = MorganFusionMoleculeEmbeddingModel(
            n_bits=n_bits,
            chemprop_mpnn=mpnn,
            rdkit_featurizer=RDKitFeaturizer(),
            selected_rdkit_features=selected_rdkit_features,
