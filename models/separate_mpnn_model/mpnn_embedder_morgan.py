...
class MorganFusionMoleculeEmbeddingModel(nn.Module):
    def __init__(
        self,
        n_bits: int,
        ...
        self.morgan_projection = nn.Linear(n_bits, self.projection_dim)
        # Fusion Layer
    ...
    def forward(self, molgraphs, rdkit_tensor, morgan_tensor):
        """
        ...
        projected_morgan = self.morgan_projection(morgan_tensor)

        # Concatenate features
        fused_input = torch.cat([mpnn_out, projected_rdkit, projected_morgan], dim=-1)
